...
The first unit root test I employ is the Im-Pesaran-Shin t-bar test to replicate @Kul test. The results below show that the null hypothesis (there exists a unit root) is rejected at the conventional levels of significance^[I found out this is a fancy way of saying reject at 1% and 5%] \ref{ips} -2.86 5% -2.66 
